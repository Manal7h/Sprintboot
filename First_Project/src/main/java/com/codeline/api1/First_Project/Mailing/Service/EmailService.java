package com.codeline.api1.First_Project.Mailing.Service;

import com.codeline.api1.First_Project.Mailing.Model.EmailDetails;
import com.codeline.api1.First_Project.Mailing.Repositories.EmailRepository;
...
@Service // add all the functions/method
public class EmailService implements EmailRepository { // want to access everything from the 'EmailRepository'
    ...
    public String sendSimpleMail(EmailDetails details) {
        ...
        try {
            ...
            mailMessage.setTo(details.getRecipient().get(0)); // (.get(0)) to start from the index zero which is the 1st Recipient, because Recipient is a list
